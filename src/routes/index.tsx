...
import { LoveLockSection } from "@/components/love-lock-section";
import { SecondNameSurprise } from "@/components/second-name-surprise";
...
function Index() {
  ...
  return (
    ...
    <div aria-hidden="true" className="iridescent-shimmer" />
    <NightSky fixed count={90} />
    <Moon />
    <ClickSparkles />
    <CursorTrail />
    ...
    {opened && <TeddySurprise />}

    <div key={opened ? "opened" : "sealed"} className="min-h-screen bg-transparent font-body text-cream">
      {/* ---------- HERO: animated welcome ---------- */}
      <section className="relative min-h-screen overflow-hidden bg-blush/0">
        {/* ambient glow blobs — gold + warm night tones */}
        <div aria-hidden="true" className="pointer-events-none absolute inset-0">
          <div
            className="a-floaty a-pulse absolute -left-24 -top-24 size-96 rounded-full"
            style={{
              background: "radial-gradient(circle, rgba(244,199,107,.35), transparent 70%)",
            }}
          />
          <div
            className="a-floaty2 a-pulse absolute top-1/3 -right-32 size-[28rem] rounded-full"
            style={{
              background: "radial-gradient(circle, rgba(231,160,168,.25), transparent 70%)",
            }}
          />
          <div
            className="a-pulse absolute bottom-0 left-1/4 size-80 rounded-full"
            style={{
              background: "radial-gradient(circle, rgba(197,160,89,.2), transparent 70%)",
            }}
          />
        </div>
        ...
        <div className="relative z-10 flex min-h-screen flex-col">
          ...
          <div className="a-fade-1 flex items-center justify-between px-8 py-6 md:px-16">
            <div className="flex items-center gap-3">
              ...
              <span className="font-heading text-sm uppercase tracking-[0.25em] text-cream/70">
                Our Love Story
              </span>
            </div>
            <span className="font-heading text-sm uppercase tracking-[0.25em] text-cream/70">
          ...
          <p className="a-fade-2 font-heading text-base uppercase tracking-[0.35em] text-gold md:text-lg">
            A little website, made only for you
          </p>

          <h1
            className="a-name-girly mt-8 font-script leading-[0.95]"
          ...
          <p className="a-fade-3 mx-auto mt-10 max-w-2xl font-body text-2xl italic leading-relaxed text-cream/85 md:text-3xl">
          ...
          <div className="a-fade-4 mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <span className="font-body text-lg italic text-cream/70">
      ...
      {/* ---------- LOVE DECLARATION ---------- */}
      <section className="relative bg-night/70 py-24 sm:py-32">
        <div className="mx-auto max-w-2xl px-6 text-center">
          <Reveal>
            <p className="font-heading text-sm uppercase tracking-[0.3em] text-rose/80">
              For my
            </p>
            <div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 font-script text-3xl text-cream md:text-5xl">
              <span>my love</span>
          ...
          <Reveal delay={120}>
            <h2 className="mt-12 font-heading text-4xl font-semibold leading-tight text-cream md:text-5xl">
          ...
          <Reveal delay={200}>
            <p className="mx-auto mt-8 max-w-[56ch] text-pretty font-body text-lg leading-relaxed text-cream/75 md:text-xl">
      ...
      <section className="relative overflow-hidden py-24 sm:py-32">
        <div
          ...
          style={{
            background:
              "radial-gradient(110% 110% at 30% 10%, #24123f 0%, #1a0f33 60%, #150c2c 100%)",
          }}
        />
      ...
      <section id="story" className="relative scroll-mt-4 py-24 sm:py-28">
        <div className="mx-auto max-w-3xl px-6">
          <Reveal className="text-center">
            ...
            <p className="mt-4 font-body text-xl italic text-cream/60">
          ...
          <div className="relative mx-auto mt-16 max-w-xl">
            <span
              aria-hidden="true"
              className="absolute bottom-1 left-3 top-1 w-px bg-gold/40"
            />
            <div className="space-y-12 pl-12">
              {TIMELINE.map((m, i) => (
                <Reveal key={i} delay={i * 80} className="relative">
                  <span
                    className={`absolute -left-12 top-1 size-3 rounded-full ring-4 ring-night ${
                  ...
                  <h3 className="mt-1 font-heading text-2xl font-medium text-cream">
                    {m.title}
                  </h3>
                  <p className="mt-2 max-w-[56ch] text-pretty font-body text-lg text-cream/70">
                    {m.text}
                  </p>
                </Reveal>
              ))}
      ...
      <section className="relative bg-night/70 py-24 sm:py-28">
        <div className="mx-auto max-w-3xl px-6">
          ...
          <Reveal delay={120} className="mt-12">
            <ScratchCard message="You're my favorite hello and my hardest goodbye." />
          </Reveal>
        </div>
      </section>
      ...
      {/* ---------- BIG SURPRISE: guess my second name ---------- */}
        ...
        <div className="mx-auto max-w-3xl px-6 text-center">
          <Reveal>
            ...
            <p className="mt-4 font-body text-lg italic text-cream/60">
              you'll need to know me a little to unlock this one.
            </p>
          </Reveal>
      ...
      {/* ---------- LOVE LOCK: two hidden games, one secret note ---------- */}
      <section id="games" className="relative scroll-mt-4 py-24 sm:py-28">
        <div className="mx-auto max-w-3xl px-6">
          <Reveal className="text-center">
            ...
            <p className="mt-4 font-body text-lg italic text-cream/60">
              win the memory match and ace the quiz to unlock a secret note.
            </p>
          </Reveal>
      ...
      <section className="relative overflow-hidden py-24 sm:py-32">
        <div
          ...
          style={{
            background:
              "radial-gradient(120% 120% at 50% 100%, #24123f 0%, #150c2c 70%)",
          }}
        />
        <div className="relative z-10 mx-auto max-w-2xl px-6 text-center">
          <Reveal>
            <p className="font-heading text-3xl font-medium leading-tight text-cream md:text-4xl">
              P.S. — I love you, Sanaya. Today, tomorrow, and every day after.
            </p>
          </Reveal>
          <Reveal delay={120}>
            <p className="mt-6 font-script text-3xl text-cream/70">
      ...
      <footer className="border-t border-gold/20 py-8 text-center">
        <p className="font-body text-lg italic text-cream/70">
          Made with all my heart, for Sanaya ♥
        </p>
        <Link
          to="/admin"
          className="mt-3 inline-block font-body text-xs uppercase tracking-[0.2em] text-cream/25 hover:text-gold"
        >
          owner
        </Link>
